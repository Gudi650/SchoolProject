        ...
        <div class="mb-6 rounded-lg border border-indigo-100 bg-indigo-50 px-6 py-4">
          <div class="flex items-start justify-between">
            <div>
              ...
              <p class="text-sm text-slate-700 mt-1">Create, manage, and track invoices</p>
            </div>
            <div class="flex items-center gap-3">
              ...
              <button class="px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors flex items-center gap-2 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
          ...
          <div class="bg-white rounded-xl p-6 border border-green-100 shadow-sm">
            <div class="flex items-center gap-3 mb-2">
              ...
              <p class="text-sm text-slate-600">Paid Invoices</p>
            </div>
          ...
          <div class="bg-white rounded-xl p-6 border border-red-100 shadow-sm">
            <div class="flex items-center gap-3 mb-2">
              ...
              <p class="text-sm text-slate-600">Overdue Amount</p>
            </div>
          ...
          <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-x-auto relative z-0">
              <table class="w-full text-left text-sm">
                <thead class="bg-indigo-50 border-b border-indigo-100">
                  <tr>
                    <th class="px-4 py-3 font-medium text-indigo-900">Invoice ID</th>
                    <th class="px-4 py-3 font-medium text-indigo-900">Date</th>
                    <th class="px-4 py-3 font-medium text-indigo-900">Customer</th>
                    <th class="px-4 py-3 font-medium text-indigo-900">Items</th>
                    <th class="px-4 py-3 font-medium text-indigo-900">Amount</th>
                    <th class="px-4 py-3 font-medium text-indigo-900">Due Date</th>
                    <th class="px-4 py-3 font-medium text-indigo-900">Status</th>
                    <th class="px-4 py-3 font-medium text-indigo-900">Paid Date</th>
                  </tr>
                </thead>
