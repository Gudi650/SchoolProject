<div class="p-4 border-b border-slate-200">
	<div class="relative max-w-md">
		...
		<input type="text" placeholder="Search active loans..."
	...
	<table class="w-full text-left">
		...
		<tbody class="divide-y divide-slate-100">
			<tr class="hover:bg-slate-50 transition-colors">
				...
				<td class="px-6 py-3"><span class="text-xs font-medium px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-700">Active</span></td>
				<td class="px-6 py-3">
					<div class="flex items-center justify-end gap-1">
						<button class="p-1.5 text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-md transition-colors" title="Return">↩</button>
						<button class="p-1.5 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-md transition-colors" title="Renew">↻</button>
					</div>
				</td>
			</tr>
			...
			<tr class="hover:bg-slate-50 transition-colors">
				<td class="px-6 py-3">
					<div class="flex items-center gap-3">
						<img src="https://images.unsplash.com/photo-1621351183012-e2f9972dd9bf?auto=format&fit=crop&q=80&w=100&h=150"
				...
				<td class="px-6 py-3">
					<div class="flex items-center gap-3">
						<img src="https://i.pravatar.cc/150?u=15" alt="Noah Brown"
							class="w-8 h-8 rounded-full border border-slate-200" />
						<div>
				...
				<td class="px-6 py-3 text-sm text-slate-600">Oct 25</td>
				<td class="px-6 py-3"><span class="text-xs font-medium px-2 py-0.5 rounded-md bg-emerald-50 text-emerald-700">Active</span></td>
				<td class="px-6 py-3">
					<div class="flex items-center justify-end gap-1">
						<button class="p-1.5 text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 rounded-md transition-colors" title="Return">↩</button>
