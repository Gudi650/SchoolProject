    ...
    <main class="flex-1 md:ml-64 p-6 md:p-10 min-w-0 overflow-x-auto">
        ...
        <section id="classResults" class="bg-white p-6 rounded-lg shadow-sm mt-6">
          <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold">Class Summary — Generate Averages</h3>
            <p class="text-sm text-gray-500">Compute student averages across posted subjects and rank them.</p>
          </div>

          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 items-end">
            <div>
              <label class="text-sm text-gray-600">Select Class</label>
              <select id="avgGradeSelect" class="w-full border rounded px-3 py-2">
            ...
            <div class="flex gap-2 justify-end">
              <button id="generateAvgBtn" class="px-4 py-2 bg-indigo-600 text-white rounded">Generate</button>
