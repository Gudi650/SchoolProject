        ...
        <section class="bg-white p-6 rounded shadow mb-8">
          ...
          <form class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-2">
            <div>
              ...
              <select id="prioritySubjects" multiple class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400">
            ...
            <div>
              <label for="breaks" class="block text-sm font-medium text-gray-700 mb-1">Break Times (e.g. 10:00-10:20, 12:00-12:30)</label>
              <input id="breaks" type="text" placeholder="e.g. 10:00-10:20, 12:00-12:30" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
              <span class="text-xs text-gray-400">Separate multiple breaks with commas.</span>
            </div>
            <div>
              <label for="classTimes" class="block text-sm font-medium text-gray-700 mb-1">Class Start & End Times</label>
              <input id="classTimes" type="text" placeholder="e.g. 09:00 - 15:00" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
            </div>
            <div>
              ...
              <span class="text-xs text-gray-400">Specify any day with different times or fewer periods.</span>
            </div>
            <div>
              <label for="periodsPerDay" class="block text-sm font-medium text-gray-700 mb-1">Periods Per Day</label>
              <input id="periodsPerDay" type="number" min="1" max="10" placeholder="e.g. 6" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
            </div>
            <div>
              ...
              <span class="text-xs text-gray-400">Specify if any day has fewer periods.</span>
            </div>
            <div class="md:col-span-2">
              <label for="diffTimetableClasses" class="block text-sm font-medium text-gray-700 mb-1">Classes with a Different Timetable</label>
              ...
              <span class="text-xs text-gray-400">List classes that have a different timetable from the rest (comma separated).</span>
            </div>
            <div class="md:col-span-2">
              <label for="diffTimetableTimes" class="block text-sm font-medium text-gray-700 mb-1">Custom Start & End Times for These Classes</label>
              <input id="diffTimetableTimes" type="text" placeholder="e.g. Grade 3: 10:00 - 14:00, Grade 5: 08:30 - 12:30" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400 mb-2" />
              <span class="text-xs text-gray-400">Specify custom times for each class as needed.</span>
            </div>
            <div class="md:col-span-2">
              ...
              <span class="text-xs text-gray-400">List any extra curriculum activities (comma separated).</span>
            </div>
            <div class="md:col-span-2">
              <label for="extraCurricularTimes" class="block text-sm font-medium text-gray-700 mb-1">Start & End Times for Extra Curriculum Activities</label>
              ...
              <span class="text-xs text-gray-400">Specify times for each activity as needed.</span>
            </div>
          </form>
          <div class="flex justify-end mt-4">
            <button type="button" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-8 py-3 rounded shadow transition flex items-center gap-2 text-lg">
