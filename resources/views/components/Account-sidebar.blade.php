  ...
  <body class="antialiased bg-slate-50 text-slate-900">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-screen bg-white border-r border-slate-200 z-40 w-72 -translate-x-full md:translate-x-0 transition-all duration-300 ease-in-out flex flex-col shadow-sm">
      ...
      <nav class="flex-1 overflow-y-auto pt-2 px-3 min-h-0">
          ...
          <li>
            <div class="relative">
              <button id="feeToggle" aria-expanded="{{ request()->routeIs('accounting.feeManagement', 'accounting.feeAnalytics', 'accounting.feeStructure', 'accounting.feeCollection') ? 'true' : 'false' }}" class="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('accounting.feeManagement', 'accounting.feeAnalytics', 'accounting.feeStructure', 'accounting.feeCollection') ? 'text-indigo-700 bg-indigo-100/50' : 'text-slate-700 hover:bg-indigo-100/50 hover:text-indigo-700' }}">
          ...
          <li>
            <div class="relative">
              <button id="loanToggle" aria-expanded="{{ request()->routeIs('accounting.loansManagement', 'accounting.proposalManagement','accounting.loanList','accounting.loanDisbursements') ? 'true' : 'false' }}" class="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg {{ request()->routeIs('accounting.loansManagement', 'accounting.proposalManagement','accounting.loanList','accounting.loanDisbursements') ? 'text-indigo-700 bg-indigo-100/50' : 'text-slate-700 hover:bg-indigo-100/50 hover:text-indigo-700' }}">
                <span class="flex items-center gap-3">
              ...
              <ul id="loanMenu" class="{{ request()->routeIs('accounting.loansManagement', 'accounting.proposalManagement','accounting.loanList','accounting.loanDisbursements') ? 'mt-1 space-y-1 pl-10' : 'hidden mt-1 space-y-1 pl-10' }}">
                ...
                <li>
                  <a href="{{ route('accounting.loanDisbursements') }}" 
                  class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('accounting.loanDisbursements') ? 'text-indigo-700 bg-indigo-100/50' : 'text-slate-700 hover:bg-indigo-100/50 hover:text-indigo-700' }}">
